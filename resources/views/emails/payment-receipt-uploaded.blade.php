...
<body>
    ...
    <div class="payment-details">
        ...
        <p><strong>Invoice Amount:</strong> ${{ number_format($invoice->invoice_amount, 2) }}</p>
        <p><strong>Upload Date:</strong> {{ now()->format('F d, Y H:i:s') }}</p>
    </div>

    <p>Please verify the payment receipt and update the payment status accordingly.</p>

    <a href="{{ route('admin.bookings.show', $booking->id) }}" class="action-button">View Booking Details</a>
