...
<body>
    ...
    <div style="background-color: #f8f9fa; padding: 20px; border-radius: 5px; margin-bottom: 20px;">
        ...
        <p style="margin-top: 10px;">We regret to inform you that your Shipping Instruction change request has been rejected.</p>
    </div>
    ...
    <div style="background-color: #fef2f2; padding: 20px; border-radius: 8px; border-left: 4px solid #ef4444; margin-bottom: 20px;">
        ...
        <p style="white-space: pre-wrap; color: #7f1d1d;">{{ $changeRequest->approver_note }}</p>
    </div>
    @endif
