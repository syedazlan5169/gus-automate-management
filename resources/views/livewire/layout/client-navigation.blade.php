            ...
            <div class="flex flex-1 gap-x-4 self-stretch lg:gap-x-6">
                ...
                <div class="flex items-center gap-x-4 lg:gap-x-6">
                    ...
                    <div class="relative" x-data="{ open: false }">
                        <button type="button" class="-m-1.5 flex items-center p-1.5" id="user-menu-button" @click="open = !open" :aria-expanded="open" aria-haspopup="true">
                        ...
                        <div
                            ...
                            tabindex="-1"
                        >
                            <a href="#" class="block px-3 py-1 text-sm/6 text-gray-900 hover:bg-gray-50" role="menuitem" tabindex="-1" id="user-menu-item-0" @click="open = false">Your profile</a>
                            <a href="#" class="block px-3 py-1 text-sm/6 text-gray-900 hover:bg-gray-50" role="menuitem" tabindex="-1" id="user-menu-item-1" @click="open = false">Sign out</a>
                        </div>
                    </div>
                </div>
            </div>
