                                ...
                                <ul role="list" class="-mx-2 space-y-1">
                                    <li>
                                        <x-responsive-nav-link :href="route('client.dashboard')"
                                            :active="request()->routeIs('client.dashboard')" wire:navigate>
                ...
                <ul role="list" class="flex flex-1 flex-col gap-y-7">
                    <li>
                        <ul role="list" class="-mx-2 space-y-1">
                            ...
                            <!-- Temporary routes -->
                            <x-nav-link href="{{ route('booking.index-new-ui') }}"
                                :active="request()->routeIs('booking.index-new-ui')">
                                <svg class="size-6 shrink-0 text-gray-400 group-hover:text-white" fill="none"
                                    viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true"
                                    data-slot="icon">
                                    <path stroke-linecap="round" stroke-linejoin="round"
