<x-app-layout>
    <div class="mx-auto flex w-full max-w-10xl flex-col px-4 py-10 sm:px-6 lg:px-8">
        ...
        <div class="max-w-xl pb-8 space-y-2">
            ...
            <!-- Heading -->
            <h1 id="create-shipping-route-heading" class="text-3xl font-bold tracking-tight text-gray-900">Create Shipping Route</h1>
        </div>
                                ...
                                <div class="border-b border-gray-900/10 pb-12 space-y-6">
                                    ...
                                    <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                                        <div class="sm:col-span-3">
                                            ...
                                            <x-text-input id="origin" name="origin" type="text" class="mt-1 block w-full" required />
                                            @error('origin')
                                        ...
                                        <div class="sm:col-span-3">
                                            ...
                                            <x-text-input id="destination" name="destination" type="text" class="mt-1 block w-full" required />
                                            @error('destination')
                                                <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                                            @enderror
                                        </div>
